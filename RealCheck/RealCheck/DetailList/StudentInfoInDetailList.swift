...
struct StudentInfoInDetailList : View {
...
struct StudentInfoInDetailList_Previews: PreviewProvider {
    static var previews: some View {
        StudentInfoInDetailList(student: Student(name: "이승철", phoneNum: "01012345678", temperture: "36.1도", symptom: "무증상", check: false))
    }
}
